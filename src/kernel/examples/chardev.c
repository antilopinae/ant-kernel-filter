...
// You need to read from /dev/chardev (or open the file with a program)
// and the driver will put the number of times the device file has been read from into the file.
// We do not support writing to the file (like echo "hi" > /dev/chardev ),
